...
export const ODIN_STRINGS_SEARCH_PLACEHOLDER = `Filter by ${ODIN_STRINGS_PREPAREDNESS}, ${ODIN_STRINGS_STATION}, ${ODIN_STRINGS_EMERGENCY} or ${ODIN_STRINGS_ALARM_RECEIVED}`;